	  ...
	  <div >
						...
						<el-row >
							<div style="padding-left: 40px;display: flex;flex-direction: row;">
								<div style="padding-top: 30px;">
									<span style="font-weight: 500;font-size: 16px;color:#8C939D;">晚归人数：</span>
								</div>
				...
				<el-row>
					<div style="height: 90px;background-color: white;">
						<el-row >
							<div style="padding-left: 40px;display: flex;flex-direction: row;">
								<div style="padding-top: 30px;">
									<span style="font-weight: 500;font-size: 16px;color:#8C939D;">未归人数：</span>
								</div>
								<div style="padding-top: 10px;">
					...
					<el-row>
						<el-form-item prop="alarmName" style="zoom: 0.9;">
							<div style="font-weight: 550;">
								<span class="span1" style="font-size: 17px;">学生姓名</span>
								  <el-input
		...
		<div >
			...
			<el-table-column  label="" align="center" type="expand">
			      ...
			      <el-table-column prop="status" label="打卡状态"  align="center">
					  <template slot-scope="scope">
						  <div style="">
							  ...
							  <span style="padding-left: 10px;" v-if="scope.row.status == '1'">晚归</span>
							  <span style="padding-left: 10px;" v-if="scope.row.status == '0'">正常</span>
							  <span style="padding-left: 10px;" v-if="scope.row.status == '2'">未归</span>
						  </div>
					  </template>
				  </el-table-column>
			  ...
			  <el-table-column label="寝室号" prop="dorm" align="center"></el-table-column>
				<el-table-column label="班级" prop="class" align="center"></el-table-column>
				<el-table-column label="家长姓名" prop="parent" align="center" width="90px"></el-table-column>
					<el-table-column label="家长联系电话" prop="phone" align="center"></el-table-column>
