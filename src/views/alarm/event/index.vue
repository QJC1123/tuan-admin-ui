								...
								<el-row style="padding-top: 30px;padding-left: 20px;">
									...
									<el-form class="" ref="form2" :model="form2" label-width="80px" style="background-color: white;" >
										...
										<el-row style="padding-top: 10px;">
											...
											<el-col :span="6">
												<span style="font-size: 15px;font-weight: 540;color: #1d2129;line-height: 22px;">5分钟</span>
										...
										<el-row style="padding-top: 10px;">
											...
											<el-col :span="6" style="padding-top: 5px;">
												<div style="font-size: 14px;width:200px">
													<el-row>
														<span style="font-size: 15px;font-weight: 540;color: #1d2129;line-height: 22px;">
															监控摄像头“{{form.cameraName}}”在“{{form.alarmLocation}}”检测到“{{form.alarmLevel}}” : “{{form.alarmName}}”,属于“{{form.alarmType}}”类型,请立即前往处理！</span>
													</el-row>
												</div>
										...
										<el-row style="padding-top: 10px;">
											...
											<el-col :span="6" style="padding-top: 5px;">
												<span style="font-size: 15px;font-weight: 540;color: #1d2129;line-height: 22px;">无</span>
												<!-- <textarea cols="55" rows="5" style="font-size: 15px;font-weight: 540;"  v-model="form.description"></textarea> -->
											</el-col>
										</el-row>
									</el-form>
...
export default {
  ...
  methods: {
    ...
    getList() {
	  ...
	  // axios.get('/alarm/getAllAlarms/'+this.queryParams.pageNum+'/'+this.queryParams.pageSize, {params:this.queryParams1}).then((response) => {
	  //  	this.eventList = response.data.records;
	  //  	this.total = response.data.total;
	  //  	this.loading = false;
	  // });
	  
	  // listEventbypr(this.queryParams.pageNum,this.queryParams.pageSize,this.queryParams1).then(response => {
	  //   this.eventList = response.data.records;
	  //   this.total = response.data.total;
	  //   this.loading = false;
	  // });
